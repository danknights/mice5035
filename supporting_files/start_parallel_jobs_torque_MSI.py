...
__credits__ = ["Jens Reeder", "Rob Knight", "Greg Caporaso", "Jai Ram Rideout", "Hu Huang"]
__license__ = "GPL"
...
from make_MSI_cluster_jobs_itasca import make_jobs, submit_jobs
...
script_info['optional_options'] = [
    ...
    make_option('-g', '--mem', type='int', 
                    help='the total memory to use (gb) [default:%default]',
                    default=16)
...
def main():
    ...
    if (opts.make_jobs):
        filenames = make_jobs(commands, job_prefix, opts.queue, opts.job_dir, (opts.max_walltime + ":00"), opts.nodes, opts.cpus, opts.mem)
    else:
